...
Tpdir=/tmp
Converterpl=./chirp.pl

echo "usage mapchirp.sh track_kml 2M_csv 70cm_csv near_miles widearea_miles includeWX(0or1) generate_lat/lon(0or1)"
...
$Converterpl $Tpdir/ntrip2m.csv ./2mout.csv ./2mgpsout.csv $6 $7
$Converterpl $Tpdir/ntrip70cm.csv ./70cmout.csv ./70cmgpsout.csv 0 $7

echo "tables converted to chirp compatible"
